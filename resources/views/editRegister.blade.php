...
@section('content')
    ...
    @endif
    <h1 style="text-align: center">Register Update</h1>
    <hr>
    <form action="{{ url('/registerUpdate') }}" method="POST" class="form-horizontal" onsubmit="return validateForm()">
        {{ csrf_field() }}
        <div class="well">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input id="register_id" type="number" value="{{ $register->num }}" name="register_num" placeholder="Enter register number" class="form-control" required maxlength="7">
                        </div>
                        <label for="adress">Address</label><br>
                        <div class="input-group">
                            <input id="adress_id" type="text" value="{{ $register->address }}" name="adress" placeholder="Enter Address" class="form-control" required>
                        </div>
                        <label for="phone_num">Phone Number</label><br>
                        <div class="input-group">
                            <input id="phone_id" type="number" value="{{ $register->phonenum }}" name="phone_num" placeholder="Enter Phone number" class="form-control" required maxlength="10">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="sector_name">Sector</label><br>
                        <div class="input-group">
                            <input id="field_id" type="text" value="{{ $register->sector }}" name="sector_name" placeholder="Enter Sector name" class="form-control" required>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input id="carnet_id" type="number" value="{{ $register->numcarnet }}" name="carnet_num" placeholder="Enter Carnet number" class="form-control" required maxlength="15">
                        </div>
                        <div class="form-group">
                            <label for="email">Email</label><br>
                            <div class="input-group">
                                <input id="email_id" type="email" value="{{ $register->email }}" name="email_name" placeholder="Enter Email" class="form-control" style="width: 200px" required>
                            </div>
                        </div>
                    <div class="form-group">
                        <label for="origin_name">Origin Fokontany</label><br>
                        <div class="input-group">
                            <input id="origin_id" type="text" value="{{ $register->origin_fokontany }}" name="origin_name" placeholder="Enter Origin Fokontany name" class="form-control" required>
                        </div>
                ...
                <div class="input-group" style="display: inline-block; width: 200px;">
                    <input id="modified_id" type="date" value="{{ $register->modified_at }}" name="modified_name" required>
                </div><br>

                <label for="arrival_name" style="display: inline-block; width: 150px; margin-top:10px;">Arrival date</label>
                <div class="input-group" style="display: inline-block; width: 200px;">
                    <input id="arrival_id" type="date" value="{{ $register->arrival_date }}" name="arrival_name" required>
                </div><br>

                <label for="departure_name" style="display: inline-block; width: 150px; margin-top:10px;">Departure date</label>
                <div class="input-group" style="display: inline-block; width: 200px;">
                    <input id="departure_id"  type="date" value="{{ $register->departure_date }}" name="departure_name">
                </div><br>
                ...
                <div class="col-md-6">
                    ...
                    <a href="/register_list" class="btn btn-danger" style="margin-top: 10px;">Cancel</a>
                <script>
