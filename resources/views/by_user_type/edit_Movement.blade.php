...
<body>
    <div class="container mt-5">
     ...
     <hr>
     <form action="{{ url('/fokontany/movement/update') }}" method="POST" class="form-horizontal" onsubmit="return validateForm()">
         {{ csrf_field() }}
         <div class="container">
             <div class="row">
                 <div class="col-md-6">
                     <div class="form-group">
                         ...
                         <div class="input-group">
                             <input id="departure_date_id" type="Date" value="{{$movement->departure_date}}" name="departure_date" class="form-control">
                         </div>
                     </div>
                 </div>
     ...
     <div class="row" style="margin-left:400px; width:10%; margin-top:20px">
         <div class="col-md-12" style="display: flex;">
             ...
             <a href="/fokontany/movement/list" class="btn btn-primary" style="margin-left: 5px;">Cancel</a>
         </div>
     </div>
  </form>
  <script>
